...
from losses import dice_coef_loss, log_dice_loss
from metrics import f1

model = tf.keras.models.load_model('model_060721183636', custom_objects={'log_dice_loss': log_dice_loss,
                                                             'f1': f1})

image = cv2.resize(cv2.imread("/home/livanosg/projects/mel-seg/data/ph2/data/IMD015/IMD015_Dermoscopic_Image/IMD015.bmp"), (224, 224))
